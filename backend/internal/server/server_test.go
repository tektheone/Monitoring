...
// TestMilestone8POSTSuccess tests POST success scenarios with 204 responses
func TestMilestone8POSTSuccess(t *testing.T) {
	server := setupTestServer(t)
	router := server.Router()
...
// TestMilestone8NotFoundHandling tests 404 handling for unknown device IDs
func TestMilestone8NotFoundHandling(t *testing.T) {
	server := setupTestServer(t)
	router := server.Router()
...
// TestMilestone8BadRequestHandling tests 400 handling for invalid JSON payloads
func TestMilestone8BadRequestHandling(t *testing.T) {
	server := setupTestServer(t)
	router := server.Router()
...
// TestMilestone8GETLogic tests GET logic for 200 vs 204 response rules
func TestMilestone8GETLogic(t *testing.T) {
	server := setupTestServer(t)
	router := server.Router()
...
// TestMilestone8JSONFormat tests exact JSON format validation
func TestMilestone8JSONFormat(t *testing.T) {
	server := setupTestServer(t)
	router := server.Router()
